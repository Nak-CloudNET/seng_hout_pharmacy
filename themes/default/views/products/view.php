        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var oTable = $('#SlRData').dataTable({
                    ...
                    'sAjaxSource': '<?= site_url('reports/getSalesReportByProID2/?v=1'.$v) ?>',
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
						...
						<div id="form">
							<?php echo form_open("products/view/" . $product->id."/#sales"); ?>
								<div class="row">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var oTable = $('#PoRData').dataTable({
                    ...
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('reports/getPurchasesReportByProID/?v=1'.$v.'&product=' . $product->id) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
            ...
            <div class="box-header">
                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        ...
                        <li class="dropdown">
                            <a href="javascript:void(0);" class="toggle_up2 tip" title="<?= lang('hide_form') ?>">
                                <i class="icon fa fa-toggle-up"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a href="javascript:void(0);" class="toggle_down2 tip" title="<?= lang('show_form') ?>">
                                <i class="icon fa fa-toggle-down"></i>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="introtext"><?php echo lang('list_results'); ?></p>
                        <div id="form2">
                            <?php echo form_open("products/view/" . $product->id."/#purchases"); ?>
                                <div class="row">
