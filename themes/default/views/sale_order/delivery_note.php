        ...
        <div class="col-lg-12">
            <?php if ($logo) { ?>
                ...
                <div class="col-xs-6 text-center">
                    ...
                    ?> 
					 <h3><strong><u><?= lang("deliver_note")?></u></strong></h3>
                </div>
                <div class="col-xs-3">
            ...
            <br>
            <div class="row">
                <div class="col-sm-6 col-xs-6" style="float: left;font-size:16px">
                    <table>
                        <tr>
                            <td>
                                <p><b><?= lang("customer");?></b></p>
                            </td>
                            <td>
                               <p>&nbsp;:&nbsp;</p>
                            </td>
                ...
                <div class="col-sm-6 col-xs-6"  style="float:right !important; font-size:16px; margin-right:0px !import;">
                    <table>
                        <tr>
                            <td>
                                <p><b><?= lang("Deli_n"); ?><sup>o</sup></b></p>
                            </td>
                            <td>
                                <p>&nbsp;:&nbsp;</p>
                            </td>
            ...
            <br>
            <div class="row">
                    <div class="col-lg-4 col-ms-4 col-xs-4" style="font-size: 16px">
						<center>
                        <p class="bold">
							<strong>
								Receive by
                    ...
                    <div class="col-lg-4 col-ms-4 col-xs-43" style="font-size: 16px">
						<center>
                        <p class="bold">
							<strong>
								Stock Keeper / Issued_by
							</strong>
                        </p>
                        <br><br><br><br>
                        <p><?= lang("name"); ?> : ...............................</p>
