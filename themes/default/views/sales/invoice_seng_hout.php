...
<body>
		...
		<div class="col-xs-12" style="width:810px !important;">
			...
			<div class="row">
				<div class="col-sm-12 col-xs-12 inv" style="margin-top: -18px !important">
					<center>
						<h4>វិក្កយបត្រ</h4>
						<h4 style="margin-top:-8px !important;"><b>INVOICE</b></h4>
					</center>
				</div>
			</div>
			<div class="row">
	...
	<div style="width: 821px;margin: 0 auto; margin-top: 20px">
		...
		<a class="btn btn-primary no-print" href="<?= site_url('sales/invoice_cid/' . $sid); ?>" target="_blank">
        	<i aria-hidden="true"></i>&nbsp;<?= lang("tax_invoice"); ?>
     	</a>
		<a class="btn btn-primary no-print" href="<?= site_url('sales/invoice_none_title/' . $sid); ?>" target="_blank">
        	<i aria-hidden="true"></i>&nbsp;<?= lang("none_title"); ?>
     	</a>
	</div>
</body>
</html>