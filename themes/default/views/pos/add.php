					...
					<?php } ?>
                        <div id="print">
                            ...
                            <div id="left-bottom">
                                ...
                                <div id="botbuttons" style="text-align:center;">
                                    ...
                                    <div class="btn-group btn-group-justified">
                    					...
                    					<div class="btn-group">
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
                                                    <button type="button" title="Print Order - <?= $pos_settings->print_items_list ?>" class="btn btn-primary" id="print_order_food">
                                                        <i class="fa fa-print"></i> <?= lang('order_food'); ?>
                                                    </button>
													<button type="button" title="Print Order - <?= $pos_settings->print_items_list ?>" class="btn btn-primary" id="print_order_drink">
                                                        <i class="fa fa-print"></i> <?= lang('order_drink'); ?>
                                                    </button>
													<!--
								...
								<input type="hidden" name="suppend_name" value="<?= $suppend_name ? $suppend_name : '';?>">
												...
												<?php
													...
													if ($Owner || $Admin) {
														...
														foreach($userBankAccounts as $userBankAccount) {
															if($userBankAccount->accountname == 'Cash') { 
