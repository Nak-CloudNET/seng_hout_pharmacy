...
class Transfers_model extends CI_Model
{
   ...
   public function getAllTransfersInvoice($transfer_id)
    {
        $this->db->select('erp_transfer_items.option_id,erp_transfers.*,erp_transfer_items.product_name,erp_transfer_items.product_code, erp_transfer_items.quantity, erp_transfer_items.expiry, erp_units.name as unit');
