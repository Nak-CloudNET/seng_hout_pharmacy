...
class Project_plan extends MY_Controller
{
	...
	public function add()
	{
		...
		if ($this->form_validation->run() == true && $this->project_plan_model->addProjectPlan($data, $products)) {
            ...
            redirect('project_plan/project_plan_form');
		} else {
	...
	{
		$reference_no = $this->project_plan_model->getProjectPlan($id);
		//$this->erp->print_arrays($reference_no);
		$date = $this->project_plan_model->getProjectPlan($id);
		$plan  = $this->project_plan_model->getProjectPlan($id);
		$note = $this->project_plan_model->getProjectPlan($id);
		//$this->erp->print_arrays($note);
